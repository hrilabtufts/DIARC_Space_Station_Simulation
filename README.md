...
LLM_PORT=9900
SERVER="../Space_Station_SMM_Server_3.6.4_Linux"
...
This file (which does not need to be named "server_settings.json" but should be valid JSON) will be swapped into the Unity server directory before launching.
...
```
usage: python launch.py run [-h] [-g] [-r ROBOTS] [-s] [-n] [-o OUTPUT]
...
```
usage: python launch.py dev [-h] [-g] [-r ROBOTS] [-s] [-n] [-o OUTPUT] diarc [diarc ...]
